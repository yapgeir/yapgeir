...
pub enum ScanCode {
    ...
    BrightnessUp = 276,
    DisplaySwitch = 277,
    KbdIlluminationToggle = 278,
    KbdIlluminationDown = 279,
    KbdIlluminationUp = 280,
    Eject = 281,
    Sleep = 282,
    App1 = 283,
    App2 = 284,
...
const BLOCKS: usize = u32_blocks(ScanCode::COUNT);

#[derive(Default, Deref, DerefMut)]
pub struct Keyboard(Buttons<BLOCKS, ScanCode>);
